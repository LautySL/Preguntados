...
class JuegoController
{
    ...
    public function verificarRespuesta()
    {
        ...
        if (!isset($_SESSION['token_usado'])) {
            $_SESSION['token_usado'] = false;
        }
    ...
    public function versusBot()
    {
        ...
        unset($_SESSION['puntaje_final']);
        unset($_SESSION['finalizado']);
        $_SESSION['modo_versus'] = true;

        $idUsuario = $_SESSION['id_usuario'];

        $idPartida = $this->model->crearPartidaVersusBot($idUsuario);
        $_SESSION['id_partida'] = $idPartida;
        header("Location: /juego/get");
        exit();
    }
