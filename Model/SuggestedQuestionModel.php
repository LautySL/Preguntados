...
class SuggestedQuestionModel {
    ...
    public function addSuggestedQuestion($pregunta, $categoria, $usuario_id, $respuestas) {
        ...
        $sql = "INSERT INTO preguntas_sugeridas (pregunta, categoria, usuario_id) VALUES ('$pregunta', '$categoria', $usuario_id)";
        if ($this->db->execute($sql)) {
            ...
            foreach ($respuestas as $respuesta) {
                ...
                $sql = "INSERT INTO respuestas_sugeridas (pregunta_id, respuesta, es_correcta) VALUES ($pregunta_id, '$respuesta_texto', $es_correcta)";
                $this->db->execute($sql);
            }
